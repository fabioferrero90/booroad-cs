  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="container mx-auto p-4 max-w-350">
        <div className="rounded-lg bg-gray-700 p-4 flex justify-between items-center my-3">
          <h2 className="text-white">FRANCO ROSSETTI</h2>
        ...
        <div className="container mx-auto p-4 max-w-350">
          <div className="rounded-lg bg-gray-700 p-4 flex justify-between items-center my-3">
            <h2 className="text-white">GIACOMO NICOLINI</h2>
            <div className="flex space-x-2 ml-auto">
              {/* mail */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
